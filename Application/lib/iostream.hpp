...
public:
  ...
  IStream(IFile &file) { file_in = &file; }
  ...
  */
  void set_file_in(IFile &file) { file_in = &file; }
};
...
public:
  ...
  OStream(OFile &file) { file_out = &file; }
  ...
  */
  void set_file_out(OFile &file) { file_out = &file; }
  ...
  */
  template <class T> OStream &hex(T x, int count) {
    while (count-- > 0) {
  ...
  Return:
      reference to instance of this stream
  */
  OStream &h(uint8_t x, int count = 2) { return hex(x, count); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &h(uint16_t x, int count = 4) { return hex(x, count); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &h(uint32_t x, int count = 8) { return hex(x, count); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &h(uint64_t x, int count = 16) { return hex(x, count); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &h(size_t x) { return hex(x, sizeof(size_t) * 2); }
  ...
  Return:
      reference to instance of this stream
  */
  template <class T> OStream &u(T x, int count = 1, const char pre = '0') {
    T modulo = 1;
    while ((x / modulo) >= 10) {
      modulo *= 10;
      count--;
  ...
  */
  ...
  Return:
      reference to instance of this stream
  */
  OStream &operator<<(char ch) { return c(ch); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &operator<<(const char *data) { return s(data); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &operator<<(unsigned x) { return u(x); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &operator<<(unsigned long long x) { return u(x); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &operator<<(int x) { return i(x); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &operator<<(long long x) { return i(x); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &operator<<(bool x) { return a(x ? '1' : '0'); }
  ...
  Return:
      reference to instance of this stream
  */
  OStream &operator<<(void *x) { // TODO:修改了打印指针符号重载
    return h(reinterpret_cast<size_t>(x), sizeof(size_t) * 2);
  }
};
